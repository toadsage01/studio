...
export const orders: Order[] = [
  { id: 'order-1', outletId: 'outlet-1', userId: 'user-2', orderDate: '2024-07-28T10:30:00Z', items: [{ skuId: 'sku-1', quantity: 24, price: 0.50 }, { skuId: 'sku-2', quantity: 12, price: 1.20 }], status: 'Fulfilled' },
  { id: 'order-2', outletId: 'outlet-2', userId: 'user-2', orderDate: '2024-07-28T14:00:00Z', items: [{ skuId: 'sku-3', quantity: 48, price: 0.75 }], status: 'Fulfilled' },
  ...
  { id: 'order-5', outletId: 'outlet-5', userId: 'user-2', orderDate: '2024-07-30T15:30:00Z', items: [{ skuId: 'sku-1', quantity: 12, price: 0.50 }], status: 'Invoiced' },
];